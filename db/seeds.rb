...
# book1 = Book.create!(title: "Catch and Kill", description: "Both a spy thriller and a meticulous work of investigative journalism, Catch and Kill breaks devastating new stories about the rampant abuse of power and sheds far-reaching light on investigations that shook our culture.", author: "Ronan Farrow", cover_image_url: "", format: "Book", publisher: "", length: 256)