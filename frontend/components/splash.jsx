    ...
    <div className="main-component-container">
      ...
      <div className="top-books">
        ...
        <div className="book-covers-container">
          ...
          />
          <img alt="book-cover" className="book-cover" src={window.deusURL} />
          <img
            alt="book-cover"
            className="book-cover"
          ...
          <img
            alt="book-cover"
            className="book-cover"
            src={window.schizo_coverURL}
          />
          <img
            alt="book-cover"
            className="book-cover"
            src={window.animalsURL}
          />
          <img
            alt="book-cover"
            className="book-cover"
            src={window.storiesURL}
          />
          <img alt="book-cover" className="book-cover" src={window.talkURL} />
          <img
            alt="book-cover"
            className="book-cover"
